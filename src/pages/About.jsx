  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow flex flex-col gap-section-gap pb-section-gap">
        {/* Hero */}
        <section className="w-full max-w-container-max mx-auto px-5 md:px-margin-edge pt-8 md:pt-section-gap">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter items-center">
            ...
            <div className="md:col-span-8 md:col-start-1 -mt-12 md:mt-0">
              <img
                src={PLACEHOLDER}
                alt=""
        ...
        {/* Section 1 */}
        <section className="w-full max-w-container-max mx-auto px-5 md:px-margin-edge">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter items-center">
        ...
        {/* Final CTA */}
        <section className="w-full max-w-container-max mx-auto px-5 md:px-margin-edge text-center py-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              to="/shop"
              className="bg-primary text-on-primary font-label-sm text-label-sm px-8 py-4 rounded-lg hover:bg-primary-container hover:shadow-lg transition-all duration-300"
            >
              {t('about_cta_shop')}
            </Link>
            <Link
              to="/custom-design"
              className="border border-primary text-primary font-label-sm text-label-sm px-8 py-4 rounded-lg hover:bg-secondary-container transition-all duration-300"
            >
              {t('about_cta_custom')}
            </Link>
          </div>
